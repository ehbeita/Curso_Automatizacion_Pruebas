...
public class RegisterPage extends BasePage{
    ...
    private By EmailRegisteredMessageLocator = By.xpath("//div[@id='account-register']/div[1]");
    ...
    public String GetEmailRegisteredMessage(){
        return driver.findElement(EmailRegisteredMessageLocator).getText();
    }
